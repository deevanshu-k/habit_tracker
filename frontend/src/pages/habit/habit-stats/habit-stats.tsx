...
import SelectHabit from "./select-habit/select-habit";
...
const HabitStats: React.FC = () => {
    ...
    const updateSelectedHabit = (habit: Habit | undefined) => {
            ...
            <div className="flex-grow">
                <div className="flex justify-between pb-4">
                    <SelectMonth
                        ...
                        year={year}
                    />
                    <SelectHabit setHabitSelected={updateSelectedHabit} />
                </div>
                <div>
                    <HabitStatsBody
                        selectedhabit={habitselected}
                        month={month}
                        year={year}
                    />
                </div>
